        ...
        <div className="px-5 pt-4 pb-6">
          ...
          <article className="px-0 lg:px-2 pb-6">
            ...
            <ul className="list-disc list-inside space-y-5">
              <li>
                <strong>10 Oct, 2023:</strong> &nbsp;<span className="font-semibold">The program structure for ADC 2023 <a className="underline" href="/ADC_2023_Program_Structure.pdf" target="_blank" rel="noreferrer">can be accessed from here</a>. (Updated on 12 Oct, 2023)</span>
              </li>
              <li>
