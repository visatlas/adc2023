    ...
    <div className="px-5 md:px-8 lg:px-10">
      ...
      <article className="pb-10">
        ...
        <ul className="list-disc list-inside space-y-3 mb-4">
          ...
          <li>The length of the initial submission should be <strong className="font-semibold">at least 8 pages but not exceed 12 pages (excluding any references),</strong> presenting most of the components (e.g., main ideas, algorithms, experiments) of a research full paper for shepherding. The length of a demo paper should be <strong className="font-semibold">at most 4 pages (excluding any references).</strong> Paper format is consistent with the research track. Please refer to the CFP of research track for details on paper format.</li>
        </ul>
        ...
        <p className="mb-4"><strong>Submission deadline.</strong> <strong>Continuous</strong> until 1 August, 2023 (23:59 <a className="underline" href="https://www.timeanddate.com/time/zones/aest" target="_blank" rel="noreferrer">AEST UTC+10</a>). The shepherding process will be carried out at any time when a submission is received until 1 August, 2023. Authors considering this track are encouraged to submit their preliminary work as early as possible for timely feedback from the delegated mentors/shepherds.</p>
        ...
        <p><strong>Camera-ready deadline.</strong> 15 September, 2023 (23:59 <a className="underline" href="https://www.timeanddate.com/time/zones/aest" target="_blank" rel="noreferrer">AEST UTC+10</a>) for already accepted papers, and 22 September, 2023 (23:59 <a className="underline" href="https://www.timeanddate.com/time/zones/aest" target="_blank" rel="noreferrer">AEST UTC+10</a>) for revision papers. When preparing the camera-ready version, authors are required to include a “Shepherding Process” section to describe briefly what has been changed after each round of the shepherding.</p>
