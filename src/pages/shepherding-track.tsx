  ...
  return (<Layout>
    ...
    <div className="px-5 md:px-8 lg:px-10">
      ...
      <article className="pb-10">
        ...
        <p><strong>Camera-ready deadline.</strong> 15 September, 2023 (23:59 <a className="underline" href="https://www.timeanddate.com/time/zones/aest" target="_blank" rel="noreferrer">AEST UTC+10</a>). When preparing the camera-ready version, authors are required to include a “Shepherding Process” section to describe briefly what has been changed after each round of the shepherding.</p>
