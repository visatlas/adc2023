    ...
    <div className="px-5 md:px-8 lg:px-10">
      ...
      <article className="pb-10">
        ...
        <ul className="list-disc list-inside space-y-3 mb-4">
          ...
          <li>The length of the initial submission should be <strong>at least 8 pages but not exceed 12 pages,</strong> presenting most of the components (e.g., main ideas, algorithms, experiments) of a research full paper for shepherding. The length of a demo paper should be <strong>at most 4 pages.</strong> Paper format is consistent with the research track. Please refer to the CFP of research track for details on paper format.</li>
        </ul>
