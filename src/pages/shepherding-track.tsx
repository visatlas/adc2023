  ...
  return (<Layout>
    ...
    <div className="px-5 md:px-8 lg:px-10">
      ...
      <article className="pb-10">
        ...
        <p className="mb-4"><strong>Submission deadline.</strong> <strong>Continuous</strong> until 1 July, 2023. The shepherding process will be carried out at any time when a submission is received until 1 July, 2023. Authors considering this track are encouraged to submit their preliminary work as early as possible for timely feedback from the delegated mentors/shepherds.</p>
