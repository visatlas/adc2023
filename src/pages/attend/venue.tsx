    ...
    <Layout>
      ...
      <div className="px-5 md:px-8 lg:px-10">
        ...
        <article className="pb-10">
          ...
          <p className="mb-6">700 Swanston St, Carlton, VIC 3053, Australia</p>
          ...
          <p className="mt-14 font-semibold text-xl">Banquet Venue</p>
          <p className="mt-2 mb-6">East Imperial (323 Rathdowne St, Carlton VIC 3053)</p>
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d197.03817091803157!2d144.9699908625135!3d-37.79916141796457!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad642d70541d569%3A0xcd5492ca719c6643!2sEast%20Imperial!5e0!3m2!1sen!2sau!4v1698218238119!5m2!1sen!2sau" height="450" className="border-0 bg-gray-200 w-full" allowFullScreen={true} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </article>
      </div>
    </Layout>
  );
