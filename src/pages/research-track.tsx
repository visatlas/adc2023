    ...
    <div className="px-5 md:px-8 lg:px-10">
      ...
      <article className="pb-10">
        ...
        <ul className="list-disc list-inside space-y-3">
          ...
          <li>Submitted files must be in PDF, where the following page limits apply: <span className="font-semibold">12 pages for research full papers, or 4 pages for demonstration proposals. 
            Please note that these limits encompass all figures and tables but do not include reference pages. In other words, references are exempt from the page count.</span></li>
